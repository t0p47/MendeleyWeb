        ...
        <tbody>
			@foreach($users as $user)
				...
				<tr>
					...
					<td><a class="user-edit" data-toggle="modal" data-target="#edituser" data-id="{{$user->id}}" data-name="{{$user->name}}" data-email="{{$user->email}}" data-ip="{{$user->ip}}">{{$user->postcount}}</a></td>
				</tr>
